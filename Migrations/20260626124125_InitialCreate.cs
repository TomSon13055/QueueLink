        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageServiceMinutes = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueServices_Venues_VenueId",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    QueueServiceId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueTickets_QueueServices_QueueServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketStatusHistories_QueueTickets_QueueTicketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailOtps_Email_IsUsed_ExpiresAt",
                table: "EmailOtps",
                columns: new[] { "Email", "IsUsed", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_QueueServices_VenueId_Name",
                table: "QueueServices",
                columns: new[] { "VenueId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_PublicToken",
                table: "QueueTickets",
                column: "PublicToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_QueueServiceId_TicketDate_TicketNumber",
                table: "QueueTickets",
                columns: new[] { "QueueServiceId", "TicketDate", "TicketNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TicketStatusHistories_QueueTicketId",
